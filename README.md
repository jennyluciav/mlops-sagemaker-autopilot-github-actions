# MLOps using Amazon SageMaker, AutoPilot and GitHub Actions

In this example, we will automate a pipeline that uses AutoPilot. The resulting trained ML model is deployed from the model registry to staging and production environments upon the approval.
